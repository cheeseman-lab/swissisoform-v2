"""Tests for scripts/site/build_evidence_records.py."""
...
SCRIPT_PATH = REPO_ROOT / "scripts" / "site" / "build_evidence_records.py"
REAL_PARQUET = REPO_ROOT / "data" / "output" / "cheeseman_12gene" / "all_paired.parquet"


def _load_module():
    spec = importlib.util.spec_from_file_location("build_evidence_records", SCRIPT_PATH)
    module = importlib.util.module_from_spec(spec)
    sys.modules["build_evidence_records"] = module
