...
|------|------|---------------------|
| swissisoform v1 | `/lab/barcheese01/ating/swissisoform/` | BED parsing, translation, mutations, genome handling |
| TIAP | `/lab/barcheese01/ating/tiap/` | Modular annotation pipeline (14 modules), pipeline.py pattern |
