"""Thin CLI for the UniProt generef fetch.

Logic lives in ``swissisoform.setup.generef``. Queries UniProtKB (reviewed,
human) for each gene symbol and writes ``data/reference/generef/generef.json``.
