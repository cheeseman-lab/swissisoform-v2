"""Build per-transcript exon-structure tables from the upstream GTF.

Gives downstream consumers (the V2 site's transcript graph, genome-LM training,
ad-hoc DNA-window extraction) a clean columnar copy of the transcript structure
without re-parsing the GTF.
