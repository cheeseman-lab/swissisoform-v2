"""D1 — reproducibility (multi-cell-line). Plumbing: site.expression."""
...
def score(site: TranslationInitiationSite, cfg: ScoringConfig) -> CriterionResult:
    """D1: TIS detected in at least ``min_cell_lines`` cell lines.
    ...
    dataset is detected in ≥1 cell line by construction, so D1 returns True
